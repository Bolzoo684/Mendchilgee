...
const QRScanner: React.FC<QRScannerProps> = ({ onScanResult }) => {
  ...
  const handleFileUpload = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    QrScanner.scanImage(file, { 
      ...
      .then((result) => {
        // result нь string байх болно returnDetailedScanResult: false болгосон учир
      ...
      .catch((error) => {
        ...
        } else if (error.message?.includes('Worker') || error.message?.includes('CSP')) {
          errorMessage = '🔧 Утсан дээр QR скан хийхэд алдаа гарлаа. Камер ашиглана уу';
        }
